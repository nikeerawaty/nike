            ...
            <form class="form-horizontal" action="/datakategori/update" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="category_name" value="{{ $p->category_name }}" placeholder="Email">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="remarks" value="{{ $p->remarks }}" placeholder="Password">
                  </div>
                </div>
